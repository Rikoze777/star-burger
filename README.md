...
[Страница сайта](https://burgingo.ru/)
...
Информация по получению YANDEX_API_KEY [тут](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/)
```sh
...
```
access_token=Ваш rollbar токен
rollbar_user=Ваш rollbar username
export access_token
export rollbar_user
```
